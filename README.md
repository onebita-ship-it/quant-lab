...
| `result*.md` | 결과·해석 리포트 (v1=`result.md`, `result_v2~v9.md`, 확정=`result_final.md`, 세후=`result_tax.md`, 연도별=`result_yearly.md`, 국면=`result_regime.md`, 배분=`result_portfolio.md`, 벤치마크=`result_benchmark.md`, 후보=`result_candidates.md`, 평균회귀=`result_mr.md`) |
